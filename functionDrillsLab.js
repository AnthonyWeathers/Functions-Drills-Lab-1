...
function compareNums(num1, num2) {
  ...
  // const compare = (num1 > num2) ? true : false
  // if (compare) {
  //   return num1
  // } 
  // return num2
...
const biggestNumber = compareNums(8, 7)
...
// console.log('arrow')
console.log('declaration') // answer
// console.log('expression')
...
const movie = bestMovie("Sharknado")
console.log(movie)
...
const revisedContestents = theEliminator(contestants, loser)
console.log(revisedContestents)
...
//CODE HERE
const string = aString => console.log(aString.toUpperCase())
string(sampleString)
...
const emailCheck = email => {
  const fixedEmail = String(email).trim()
  if (email.includes('@')) {
...
const emailEnter = emailCheck('   y394@yahoo.com' )
...
//CODE HERE
const plannedSpending = gold => gold/3
const totalFrogs = plannedSpending(35)
...
//CODE HERE
const plannedSpending2 = gold => Math.floor(gold/3) // Math.round rounds up
const totalFrogs2 = plannedSpending2(35)
...
const arrayIsAscending = ascendingCheck(sampleArray)
